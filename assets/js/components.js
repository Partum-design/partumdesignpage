(function () {
    ...
    var NAV_CSS = [
        ...
        '.logo{display:block;width:320px;height:72px;transition:width .34s ease,height .34s ease;flex-shrink:0;z-index:100000;position:relative}',
        '.logo-img{width:100%;height:100%;object-fit:contain;object-position:left center}',
        '.navbar.scrolled .logo{width:280px;height:62px}',
